	...
	if (err) throw err;
			...
			function findMinAndMax(dataColumnX) {
				...
				yMax = d3.max(mydata, function(data) {
					return +data.healthcareLow * 1.5; //LG is this because it's the default y?  come back adn check these
				});

				yMin = d3.min(mydata, function(data){
					return +data.healthcareLow * 0.3;  //LG is this because it's the default y?
			...
			var toolTip = d3.tip()
					...
					.html(function(data) {
						...
						if (currentAxisLabelX === 'poverty') {
							...
							xinfo = "Median Household Income: " + income
						}
						else {
